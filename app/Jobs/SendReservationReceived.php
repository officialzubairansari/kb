...
class SendReservationReceived implements ShouldQueue
{
    ...
    {
        $this->template = Setting::where('slug', 'reservation_received_email_template')->value('value');
    ...
    {
        Mail::to($this->userEmail)->send(new ReservationReceived($this->content));
    }
}
