                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <div class="row gy-3">
                                        <div class="col-4">
                                            <div>
                                                <label for="cron-link" class="font-bold font-18">Cron Jobs (*/5 * * * *)</label>
                                                <div class="input-group">
                                                    <input type="text" readonly class="form-control bg-light" id="cron-link" value="wget -q -O - {{ env('APP_URL') }}/send-emails?token=nyf0SUfR6YZsSUN24V">
                                                    <button class="btn btn-outline-dark shadow-none" type="button" id="copy-cron-link">Copy</button>
                                                </div>
                                            </div>
                                        </div>
