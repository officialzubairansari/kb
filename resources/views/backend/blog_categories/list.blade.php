<x-backend.layout>
    ...
    <div class="page-content">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <button onclick="createModal();" class="btn btn-dark btn-label waves-effect waves-light fs-12">New Category
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        ...
                                        @foreach($blog_categories as $category)
                                            <tr>
                                                <td><a href="#" class="fw-medium link-primary">#{{ $category->id }}</a></td>
                                                <td>{{ $category->name }}</td>
                                                <td>
                                                    <button onclick="updateModal('{{ $category->id }}', '{{ $category->name }}');"
                                                            type="submit"
                                                    ...
                                                    <button onclick="deleteModal('{{ $category->id }}', '{{ $category->name }}');"
                                                            type="submit"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('blog.categories.delete') }}" method="post">
                        @csrf
                        <div class="row g-3 mb-3">
                            <div class="col-12" hidden="">
                                <div>
                                    <label class="form-label">Category ID</label>
                                    <input name="category_id" id="category_id_delete" type="text" class="form-control" value="" required>
                                </div>
                            </div><!--end col-->
                            <div class="col-12">
                                <div>
                                    <label class="form-label">Category Name</label>
                                    <input readonly name="name" id="category_name_delete" type="text" class="form-control bg-light" value="" required>
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3">
                    ...
                    <form action="{{ route('blog.categories.update') }}" method="post">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12" hidden="">
                                <div>
                                    <label class="form-label">Category ID</label>
                                    <input name="category_id" id="category_id_update" type="text" class="form-control" value="" required>
                                </div>
                            </div><!--end col-->
                            <div class="col-12">
                                <div>
                                    <label class="form-label">Category Name</label>
                                    <input name="name" id="category_name_update" type="text" class="form-control" value="" required>
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3">
    ...
    <x-slot:js>
        <script>
            ...
            function deleteModal(category_id, category_name) {
